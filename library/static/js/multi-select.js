function MultiSelectTag(el, customs = { shadow: false, rounded: true }) {
  ...
  function createElements() {
    ...
    input.placeholder = `${customs.placeholder || "Nhập thông tin sách"}`;
  ...
  function createTag(option) {
    ...
    itemDiv.style.color = tagColor.textColor || "#1e90ff";
    itemDiv.style.borderColor = tagColor.borderColor || "#1e90ff";
    itemDiv.style.background = tagColor.bgColor || "#d7e7f7";
    const itemLabel = document.createElement("div");
    itemLabel.classList.add("item-label");
    itemLabel.style.color = tagColor.textColor || "#1e90ff";
